...
class Search extends Component{
    ...
    render(){
        ...
        const blogResults = this.state.blogResults.map((item,i)=> <BlogTile key={i} blog={item}/> )
        const userResults = this.state.userResults.map((item,i)=> <UserTile key={i} blog={item}/> )
